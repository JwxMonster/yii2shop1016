...
<head>
    ...
    <link rel="stylesheet" href="<?=\Yii::getAlias('@web')?>/css/bootstrap.css" type="text/css">
...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        <!-- 分类列表 start -->
        <div class="catlist">
            <h2><?=$categoryNows->name?></h2>
            <div class="catlist_wrap">
                <?php foreach($categoryNows->children as $child):?>
                    <div class="child">
                        <h3 class="on"><b></b><?=$child->name?></h3>
                        <ul>
                            <?php foreach($child->children as $son):?>
                                <li><a href="/goods/list?pid=<?=$child->id?>"><?=$son->name?></a></li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                <?php endforeach;?>
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach($goods as $good):?>
                    <li>
                        <dl>
                            <dt><a href=""><img src="http://www.yiishop.com<?=$good->logo?>" alt="" /></a></dt>
                            <dd><a href="/goods/show?id=<?=$good->id?>"><?=$good->name?></a></dt>
