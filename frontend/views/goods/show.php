    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://www.yiishop.com<?=$goods->logo?>" class="jqzoom" rel="gal1" >   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="http://www.yiishop.com<?=$goods->logo?>" alt="" width="351px" height="350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                            ...
                            <?php foreach($gallerys as $gallery):?>
                                <li>
                                    <a href="javascript:void(0);"
                                       rel="{gallery: 'gal1', smallimage: 'http://www.yiishop.com<?=$gallery->path?>',largeimage: 'http://www.yiishop.com<?=$gallery->path?>'}">
                                        <img src="http://www.yiishop.com<?=$gallery->path?>"></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="/cart/add-cart" method="get" class="choose">
                    <ul>
