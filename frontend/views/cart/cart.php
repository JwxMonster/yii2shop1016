...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <?php foreach ($goods as $model):?>
            <tr data-id="<?=$model['id']?>">
                <td class="col1"><a href=""><img src="http://www.yiishop.com<?=$model['logo']?>" alt="" /></a>
                ...
                <?php $count+=$model['shop_price']*$carts[$model['id']]?>
                <td class="col6"><a href="/cart/del-cart?id=<?=$model['id']?>">删除</a></td>
            </tr>
        <?php endforeach;?>
        </tbody>
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?=sprintf("%.2f",$count)?></span></strong></td>
        </tr>
        </tfoot>
    </table>
