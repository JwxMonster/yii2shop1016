...
<div class="fillin w990 bc mt15">
        ...
        <div class="goods">
            ...
            <table>
                ...
                <?php foreach($goods as $good):?>
                    <tr>
                        <td class="col1"><a href=""><img src="http://www.yiishop.com<?=$good['logo']?>" alt="" /></a>  <strong><a href=""><?=$good['name']?></a></strong></td>
                        ...
                        <?php $count+=$good['shop_price']*$carts[$good['id']]?>
                    </tr>
                <?php endforeach;?>
                </tbody>
                <tfoot>
    ...
    <div class="fillin_ft">
        ...
        <p>应付总额：<strong>￥<?=sprintf("%.2f",$count)?></strong></p>
